...
export default function Scanner() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center pt-8 px-4 pb-24">
      {/* Header */}
      ...
      {scanError && (
        <div className="w-full max-w-md mt-6 p-4 bg-red-500/20 border border-red-500/50 rounded-xl text-center backdrop-blur-sm">
          <p className="text-red-300 font-bold mb-3">{scanError}</p>
          <button
            onClick={closeModal}
      ...
      {scannedUser && (
        <div className="fixed inset-0 bg-black/95 z-50 flex flex-col items-center justify-center p-6 backdrop-blur-md">
          <h2 className="text-2xl font-black text-green-400 mb-2 uppercase tracking-widest text-center">
            GUEST VERIFIED
          </h2>
          ...
          <div className="flex flex-col w-full max-w-sm space-y-3">
            ...
            {!scannedUser.entered ? (
              ...
              <div className="w-full py-4 bg-gray-800 text-green-400 font-extrabold rounded-xl text-center border border-green-500/30">
                ✅ Already Checked In
              </div>
            )}
            ...
            <button
              onClick={closeModal}
              className="w-full py-3 bg-gray-700 hover:bg-gray-600 text-white font-bold rounded-xl flex items-center justify-center space-x-2 transition"
            >
